...
def home_page(request):
	...
	if request.user.is_authenticated() :
		content_data['content'] = 'Premerior'
	return render(request, "home_page.html", content_data )
...
def about_page(request):
	...
	print('about page')
	return render(request, "about_page.html",content_data)
...
def contact_page(request):
	...
	return render(request, "contact/contact_page.html", content_data)
